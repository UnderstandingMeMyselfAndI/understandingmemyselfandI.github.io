...
import IconOneDayAtATimeWhite from "@/src/components/icons/IconOneDayAtATimeWhite.jsx";
import SettingsMenu from "./components/ui/menus/settingsMenu/SettingsMenu";
// import {setMenuRef} from "./components/ui/menus/settingsMenu/menuController.js";

// import {startOnboarding} from ".@/src/js/onboardingManager.js";
import "./globals.css";
import "./App.css";
function App() {
	...
	// ------------------------------------------
	// Set the menu Ref - SIMPLIFIED
	// ------------------------------------------
	useEffect(() => {
		console.log("App mounted - setting menu ref");
		// setMenuRef(menuRef);
	}, []);
		...
		<div className="app">
			<div className="main">
				<div className="inner">
					...
					<div className="footer">
						...
						<p>
							...
							&hearts; &#x2661; We would really appreciate it.&#x2661; &hearts;
						</p>
					</div>
				</div>
				<FooterMetadata />
				<div className="bgImgs">
					...
					/>
					<div
						className="icon fistbump"
						dangerouslySetInnerHTML={{__html: iconEmojiFistup}}
					/>
					<div className="icon oneDay">
						<IconOneDayAtATimeWhite className="iconOneDayAtATimeWhite" />
					</div>
				</div>
			</div>
		</div>
