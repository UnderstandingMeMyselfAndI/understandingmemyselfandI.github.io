        ...
        },
        {
          ...
          "toolFieldGroup": {
            ...
            "scenariosField": {
              "nodes": [
                {
                  "databaseId": "cG9zdDo4NQ==",
                  "id": 85,
                  "__typename": "Scenario",
                  "title": "Panic Attack at Work",
                  "scenariosFieldGroup": {
                    "description": "<p>Heart racing → run to bathroom, dunk face in cold water (T), do 20 jumping jacks (I), then 4-7-8 breathing (P). Back to meeting in 90 seconds calmer.</p>\n"
                  }
                },
                {
                  "databaseId": "cG9zdDo4Ng==",
                  "id": 86,
                  "__typename": "Scenario",
                  "title": "Road Rage",
                  "scenariosFieldGroup": {
                    "description": "<p>About to lose it in traffic → crank AC on face (T), do push-ups on the steering wheel (I), box breathe at the red light (P). Arrive less murderous.</p>\n"
                  }
                }
              ]
            },
