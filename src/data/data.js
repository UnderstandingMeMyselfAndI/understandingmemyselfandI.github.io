const data = [
  {
    ...
    videos: [
      {
        title: 'The ABCDEs of Coping with Urges',
        url: 'https://www.youtube.com/watch?v=4Pmd7pzQI1M',
      },
    ],
  },
  {
      ...
      acronyms: [
        {
          ...
          meaning: 'Accept',
          definition:
            '<p>Accept the things you can’t control right now (the craving, the feeling, the situation). Fighting it just feeds it.</p>',
          scenario: '',
        },
        {
          letter: 'C',
          meaning: 'Choose',
          definition:
            '<p>Choose what matters most to you—your values, your recovery, your future self.</p>',
          scenario: '',
        },
        {
          letter: 'T',
          meaning: 'Take action',
          definition:
            '<p>Do one small thing that lines up with that choice, even if you don’t feel like it.</p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>Short, sweet Acceptance & Commitment Therapy magic. Stop wrestling with feelings and start moving toward the life you actually want.</p>',
    },
    scenarios: [
      {
      ...
      acronyms: [
        {
          ...
          meaning: 'Cost',
          definition:
            "<p>What's this behavior really costing you?<br />Think beyond money - your relationships, health, self-respect</p>",
          scenario: '',
        },
        {
          letter: 'B',
          meaning: 'Benefit',
          definition:
            '<p>Be honest - what are you getting out of this behavior?<br />There must be something, right?</p>',
          scenario: '',
        },
        {
          letter: 'A',
          meaning: 'Analysis',
          definition:
            '<p>Put it all on the table and see which side weighs more - is it worth it?</p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>Your no-BS pro/con list that cuts straight through the excuses.</p>',
    },
    scenarios: [
      {
    ...
    videos: [
      {
        ...
        url: 'https://www.youtube.com/watch?v=k2e2TNSTurs',
      },
      {
        title: 'How Does Cost-Benefit Analysis Help In SMART Recovery?',
        url: 'https://www.youtube.com/watch?v=ii1zvNDbzd0',
      },
    ],
  },
  {
      ...
      acronyms: [
        {
          ...
          definition:
            '<p>Just say <u>"not right now"</u> - you don\'t have to give in immediately.<br />Urges have expiration dates</p>',
          scenario: '',
        },
        {
          letter: 'E',
          meaning: 'Escape',
          definition:
            '<p><u>Change your scenery!</u><br />Sometimes the best thing you can do is physically remove yourself from temptation</p>',
          scenario: '',
        },
        {
          letter: 'A',
          ...
          definition:
            '<p><u>Pick your battle strategy:</u><br />dodge the trigger, accept the feeling will pass, or tackle it head-on</p>',
          scenario: '',
        },
        {
          letter: 'D',
          meaning: 'Distract',
          definition:
            '<p>Redirect that mental energy somewhere else - <b><u>call someone</u>, <u>go for a walk</u>, <u>binge a show</u></b></p>',
          scenario: '',
        },
        {
          letter: 'S',
          meaning: 'Substitute',
          definition:
            '<p>Swap out the harmful habit for something that actually <b>makes you feel good about yourself</b></p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>Five solid moves when a craving knocks. Think of cravings like door-to-door salesmen—if you stop answering, they eventually leave.</p>',
    },
    scenarios: [
      {
    ...
    videos: [
      {
        title: 'The DEADs Tool Explained',
        url: 'https://www.youtube.com/watch?v=rHl3STAGl-I',
      },
    ],
  },
  {
      ...
      acronyms: [
        {
          ...
          meaning: 'Destructive',
          definition:
            '<p>Notice when your brain is playing up and feeding you garbage thoughts and mental images. It can be a snake at times. </p>',
          scenario: '',
        },
        {
          letter: 'I',
        ...
        },
        {
          ...
          meaning: 'Self-talk',
          definition:
            "<p>What's that inner voice telling you? If it's being a jerk, it's time to change the conversation and let it know who's boss around here. </p>",
          scenario: '',
        },
        {
          letter: 'A',
        ...
        },
        {
          ...
          meaning: 'Refusal',
          definition:
            '<p>Tell those toxic thoughts who\'s in control. It\'s going to be a "thanks but no thanks" to them and your not going to engage.</p>',
          scenario: '',
        },
        {
          letter: 'M',
          meaning: 'Method',
          definition:
            '<p>Have a game plan ready to replace the junk thoughts with something better</p>',
          scenario: '',
        },
      ],
      explanation:
    ...
    videos: [
      {
        title: 'The DISARM Tool Explained',
        url: 'https://www.youtube.com/watch?v=pAVbXlXBthA',
      },
    ],
  },
      ...
      acronyms: [
        {
          ...
          meaning: 'Hungry',
          definition:
            '<p>When did you last eat? Your brain needs fuel, and "hangry" is a real thing that affects decisions. Grab something to eat. </p>',
          scenario: '',
        },
        {
          letter: 'A',
        ...
        },
        {
          ...
          meaning: 'Tired',
          definition:
            "<p>Exhausted? Your willpower runs on empty when you do - rest isn't optional. Swerve the unncessary and get yourself some sleep.</p>",
          scenario: '',
        },
      ],
      explanation:
      ...
      acronyms: [
        {
          ...
          meaning: 'Helping',
          definition:
            '<p>Do something for someone else - it gets your thinking out of your own head and <u>feels amazing</u></p>',
          scenario: '',
        },
        {
          letter: 'O',
          meaning: 'Others',
          definition:
            "<p>Build real connections with people who matter to you - <b>isolation is recovery's enemy</b></p>",
          scenario: '',
        },
        {
          letter: 'P',
          meaning: 'Purpose',
          definition:
            '<p>Find your "why" - what makes you want to get up in the morning?</p>',
          scenario: '',
        },
        {
          letter: 'E',
          meaning: 'Esteem',
          definition:
            '<p>Do things that make you <b>proud of yourself - small wins count too</b></p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>Hope isn’t something you wait for—it’s something you build, one tiny helpful action at a time.</p>',
    },
    scenarios: [
      {
  ...
  },
  {
    ...
    content: {
      acronyms: [
        ...
        },
        {
          ...
          meaning: 'Values',
          definition:
            '<p>Values are what you care about enough to act on. Not slogans. Not Instagram quotes. Values show up in what you do when it gets tough.</p>',
          scenario: '',
        },
      ],
      explanation:
    ...
    videos: [
      {
        title: 'The Hierarchy of Values Tool (HOV)',
        url: 'https://www.youtube.com/watch?v=RW63Ddsgol0',
      },
    ],
  },
  {
      ...
      acronyms: [
        {
          ...
          meaning: 'Identify',
          definition:
            '<p>Spot the problem patterns - what thoughts, feelings, or situations keep tripping you up?</p>',
          scenario: '',
        },
        {
          letter: 'C',
          meaning: 'Challenge',
          definition:
            '<p>Question everything - is this thought true? Is this behavior helping or hurting?</p>',
          scenario: '',
        },
        {
          letter: 'E',
          meaning: 'Eliminate',
          definition:
            '<p>Replace the junk with something better - out with the old, in with the helpful</p>',
          scenario: '',
        },
      ],
      explanation:
  ...
  },
  {
    ...
    content: {
      acronyms: [
        {
          ...
          meaning: 'Low',
          definition:
            '<p>Notice when your patience is running thin - this is when those crappy decisions happen - be a buddy to yourself and do a quick self check-in. </p>',
          scenario: '',
        },
        {
          letter: 'F',
          meaning: 'Frustration',
          definition:
            "<p>That feeling when things aren't going your way - totally normal, but you've got to get a game plan together.</p>",
          scenario: '',
        },
        {
          letter: 'T',
      ...
      explanation:
        "<p>Levelling up your toolbox for dealing with life's annoying moments without needing to style it out, losing your cool or your progress.</p>",
    },
    scenarios: [
      {
      ...
      acronyms: [
        {
          ...
          meaning: 'Progress',
          definition:
            "<p>Celebrate the wins, big and small - you're moving forward even if it doesn't always feel like it</p>",
          scenario: '',
        },
        {
          letter: 'I',
          meaning: 'Insight',
          definition:
            '<p>Those "aha!" moments when you finally get why you do what you do</p>',
          scenario: '',
        },
        {
          letter: 'E',
          meaning: 'Empowerment',
          definition:
            "<p>That growing sense that you're the one in charge of your life - and you're getting better at it</p>",
          scenario: '',
        },
      ],
      explanation:
        '<p>Your personal growth tracker - because recovery is about so much more than just not using.</p>',
    },
    scenarios: [
      {
      ...
      acronyms: [
        {
          ...
          meaning: 'Practice',
          definition:
            '<p>Use your recovery tools regularly, not just when things get rough - like going to the gym for your brain</p>',
          scenario: '',
        },
        {
          letter: 'P',
          meaning: 'Patience',
          definition:
            "<p>This stuff takes time, and that's totally normal - be kind to yourself while you figure it out</p>",
          scenario: '',
        },
        {
          letter: 'P',
          meaning: 'Persistence',
          definition:
            "<p>Keep going even when it sucks, especially when it sucks - that's when the real growth happens</p>",
          scenario: '',
        },
      ],
      explanation:
        "<p>The three P's that make the difference between trying recovery and actually succeeding at it.</p>",
    },
    scenarios: [
      {
  ...
  },
  {
      ...
      acronyms: [
        {
          ...
          meaning: 'Recognize',
          definition:
            '<p>Name what’s happening: “This is anxiety,” “This is shame,” “This is a craving.”</p>',
          scenario: '',
        },
        {
          letter: 'A',
          meaning: 'Allow',
          definition:
            '<p>Let it be there without fighting or feeding it. It’s already here.</p>',
          scenario: '',
        },
        {
          letter: 'I',
          meaning: 'Investigate',
          definition:
            '<p>Get curious—where do you feel it in your body? What does it need right now?</p>',
          scenario: '',
        },
        {
          letter: 'N',
          meaning: 'Nurture',
          definition:
            '<p>Offer yourself kindness—like you would a good friend or a scared kid</p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>Mindfulness superpower created by Tara Brach. Turns “I can’t handle this feeling” into “I can be with this feeling until it passes.”</p>',
    },
    scenarios: [
      {
    ...
    videos: [
      {
        title: 'The RAIN Technique Explained? - Stress Free Mindset',
        url: 'https://www.youtube.com/watch?v=8etCPEto4z4',
      },
      {
        title: 'The RAIN Method',
        url: 'https://www.youtube.com/watch?v=wN0XtQumGBk',
      },
      {
        title: 'RAIN-Method: Meditation for emotional self-regulation',
        url: 'https://www.youtube.com/watch?v=olCAX_C0iM8',
      },
      {
        title: '5-Minute Meditations: R.A.I.N Technique',
        url: 'https://www.youtube.com/watch?v=v6k5gv3nxQ8',
      },
      {
        title: 'Mindful Meditation - The R-A-I-N Technique',
        url: 'https://www.youtube.com/watch?v=kC7dJQt5BBw',
      },
      {
        title:
          'Guided Meditation: Dissolving the Trance of Unworthiness with RAIN with Tara Brach',
        url: 'https://www.youtube.com/watch?v=Ytr1V1R1rOw',
      },
    ],
  },
  {
      ...
      acronyms: [
        {
          ...
          meaning: 'Recovery',
          definition:
            '<p>Remember this is an ongoing journey, not a destination you arrive at and forget about</p>',
          scenario: '',
        },
        {
          letter: 'A',
          meaning: 'Awareness',
          definition:
            "<p>Stay tuned in to your thoughts, feelings, and triggers - don't go on autopilot</p>",
          scenario: '',
        },
        {
          letter: 'V',
          meaning: 'Vigilance',
          definition:
            '<p>Keep your eyes open for warning signs without becoming paranoid about them</p>',
          scenario: '',
        },
        {
          letter: 'E',
          meaning: 'Empowerment',
          definition:
            "<p>Trust yourself to handle whatever comes up - you've got the tools and the strength</p>",
          scenario: '',
        },
      ],
      explanation:
        '<p>Your long-term success strategy - staying strong and aware without making recovery feel like a prison.</p>',
    },
    scenarios: [
      {
      ...
      acronyms: [
        {
          ...
          meaning: 'Rational',
          definition:
            '<p>Think it through logically - what does the evidence actually say about this situation?</p>',
          scenario: '',
        },
        {
          letter: 'E',
          meaning: 'Emotive',
          definition:
            "<p>Honor your feelings without letting them run the show - they're information, not instructions</p>",
          scenario: '',
        },
        {
          letter: 'I',
          meaning: 'Imagery',
          definition:
            '<p>Use your imagination for good - picture yourself handling things well and feeling proud</p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>Balance your head and your heart with some positive visualization - the trifecta of healthy coping.</p>',
    },
    scenarios: [
      {
  ...
  },
  {
      ...
      acronyms: [
        {
          ...
          meaning: 'Specific',
          definition:
            '<p>Get crystal clear about what you want - "get better" is vague, "exercise 3x a week" is specific</p>',
          scenario: '',
        },
        {
          letter: 'M',
          meaning: 'Measurable',
          definition:
            "<p>How will you know you're making progress? You need a way to track and celebrate wins</p>",
          scenario: '',
        },
        {
          letter: 'A',
          meaning: 'Achievable',
          definition:
            '<p>Set yourself up to succeed, not fail - ambitious is good, impossible is discouraging</p>',
          scenario: '',
        },
        {
          letter: 'R',
          meaning: 'Relevant',
          definition:
            '<p>Make sure this goal actually matters to your life and recovery - not just what sounds impressive</p>',
          scenario: '',
        },
        {
          letter: 'T',
          meaning: 'Time-bound',
          definition:
            '<p>Give yourself a deadline - without one, "someday" becomes "never"</p>',
          scenario: '',
        },
      ],
      explanation:
        "<p>The gold standard for setting goals that you'll actually achieve instead of just hope for.</p>",
    },
    scenarios: [
      {
    ...
    videos: [
      ...
      {
        title: 'SMART Goals Quick Overview with 21 SMART Goals Examples',
        url: 'https://www.youtube.com/watch?v=elJcG83m-qg',
      },
      {
        title: 'How to Set SMART Goals ',
        url: 'https://www.youtube.com/watch?v=i0QfCZjASX8',
      },
    ],
  },
  {
      ...
      acronyms: [
        {
          letter: 'S',
          meaning: 'Stop',
          definition: '<p>Freeze—don’t react yet</p>',
          scenario: '',
        },
        {
          letter: 'T',
          meaning: 'Take a breath',
          definition: '<p>One slow breath (or three)</p>',
          scenario: '',
        },
        {
          letter: 'O',
          meaning: 'Observe',
          definition:
            '<p>What’s happening in your body? Thoughts? Surroundings?</p>',
          scenario: '',
        },
        {
          letter: 'P',
          meaning: 'Proceed',
          definition: '<p>Now choose your next move mindfully</p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>The ultimate 10-second emergency brake. Works for anger, cravings, panic attacks, or “about to text your ex.”</p>',
    },
    scenarios: [
      {
      ...
      },
      {
        ...
        content:
          '<p>Voice rising → S.T.O.P.<br />Pause, breathe, notice you’re flooded, say “I need a minute” and step outside. Saves relationships.</p>',
    ...
    videos: [
      {
        title: 'DBT Distress Tolerance STOP Skill',
        url: 'https://www.youtube.com/watch?v=8ykrSYe6UMk',
      },
    ],
  },
  {
      ...
      acronyms: [
        {
          ...
          meaning: 'Thoughts',
          definition:
            "<p>What's going through your mind right now? Sometimes we think things without really thinking about them</p>",
          scenario: '',
        },
        {
          letter: 'A',
          meaning: 'Assumptions',
          definition:
            '<p>What are you taking for granted that might not actually be true? Question your defaults</p>',
          scenario: '',
        },
        {
          letter: 'P',
          meaning: 'Predictions',
          definition:
            '<p>What do you think will happen? Your crystal ball might be foggier than you think</p>',
          scenario: '',
        },
        {
          letter: 'E',
          meaning: 'Evaluations',
          definition:
            '<p>How are you judging yourself and others? Are you being fair, or being a harsh critic?</p>',
          scenario: '',
        },
      ],
      explanation:
        "<p>Your mental fact-checker - helping you separate what's actually true from what just feels true.</p>",
    },
    scenarios: [
      {
    ...
    videos: [
      {
        title: 'Fact-Checking - A CBT tool',
        url: 'https://www.youtube.com/watch?v=4GEjZVZq1V0',
      },
      {
        title: 'Cognitive Fusion and Defusion in ACT',
        url: 'https://www.youtube.com/watch?v=CpdVMs818AE',
      },
    ],
  },
  {
      ...
      acronyms: [
        {
          ...
          meaning: 'Temperature',
          definition:
            '<p>Change your body temp fast—ice on face/neck or cold shower (diving reflex calms you instantly)</p>',
          scenario: '',
        },
        {
          letter: 'I',
          ...
          definition:
            '<p>30–60 seconds all-out (burpees, sprinting) to burn off stress hormones</p>',
          scenario: '',
        },
        {
          letter: 'P',
          meaning: 'Paced breathing',
          definition:
            '<p>Slow your breathing way down—4 sec in, 6 sec out (or box breathing)</p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>DBT’s fastest skills to flip your nervous system from freak-out to chill in under a minute.</p>',
    },
    scenarios: [
      {
    ...
    videos: [
      {
        title: 'TIP Skills: Reduce Extreme Emotions Quickly',
        url: 'https://www.youtube.com/watch?v=UuvH_j9O0f4',
      },
      {
        title: 'The TIPP Technique',
        url: 'https://www.youtube.com/watch?v=8nVady7A3Qo',
      },
    ],
  },
  {
    ...
    content: {
      acronyms: [
        {
          ...
          meaning: 'Proper',
          definition:
            "<p>Doing things the right way, not cutting corners. It’s about being honest with yourself and making sure what you're doing is sensible and realistic.</p>",
          scenario: '',
        },
        {
          letter: 'P',
        ...
        },
        {
          ...
          meaning: 'Prevents',
          definition:
            '<p>This is the cause-and-effect part: doing the first three steps helps to stop problems before they happen.</p>',
          scenario: '',
        },
        {
          letter: 'P',
      ...
      explanation:
        '<p><b>Proper Preparation and Planning Prevents Poor Performance</b><br />Or in recovery language: plan the night so you don’t have to fight the night.</p>',
    },
    scenarios: [
      {
      ...
      acronyms: [
        {
          ...
          meaning: 'Unwanted',
          definition:
            "<p>Acknowledge that these cravings suck and you didn't ask for them - but they're temporary visitors</p>",
          scenario: '',
        },
        {
          letter: 'R',
          meaning: 'Reduce',
          definition:
            "<p>Find ways to turn down the volume on these urges - they don't have to be so loud</p>",
          scenario: '',
        },
        {
          letter: 'G',
          meaning: 'Gradually',
          definition:
            '<p>This process takes time - be patient with yourself as the urges slowly lose their power</p>',
          scenario: '',
        },
        {
          letter: 'E',
          meaning: 'Eliminate',
          definition:
            '<p>The ultimate goal - getting to a place where these urges rarely show up at all</p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>Your step-by-step plan for making cravings less frequent, less intense, and eventually obsolete.</p>',
    },
    scenarios: [
      {
    ...
    videos: [
      {
        ...
        url: 'https://www.youtube.com/watch?v=dHzS_RBtnXE',
      },
    ],
  },
  {
      ...
      acronyms: [
        {
          ...
          definition:
            "<p>You're worthy of love and respect just because you exist - no performance required</p>",
          scenario: '',
        },
        {
          letter: 'S',
          meaning: 'Self',
          definition:
            '<p>This is about you as a whole person, not just your mistakes or achievements</p>',
          scenario: '',
        },
        {
          letter: 'A',
          meaning: 'Acceptance',
          definition:
            '<p>Embracing yourself as you are right now, while still working toward who you want to become</p>',
          scenario: '',
        },
      ],
      explanation:
        '<p>The foundation of lasting recovery - learning to be on your own team, especially when you mess up.</p>',
    },
    scenarios: [
      {
    ...
    videos: [
      {
        title: 'Unconditional Self Acceptance (USA) Explained',
        url: 'https://www.youtube.com/watch?v=sgM32-FF6gA',
      },
    ],
  },
  // {
      ...
      acronyms: [
        {
          ...
          meaning: 'Wait',
          definition:
            "<p>Hit the pause button - you don't have to react immediately to every feeling or situation</p>",
          scenario: '',
        },
        {
          letter: 'A',
          meaning: 'Assess',
          definition:
            "<p>Look around and take stock - what's really happening here, and how are you feeling about it?</p>",
          scenario: '',
        },
        {
          letter: 'I',
          meaning: 'Identify',
          definition:
            "<p>Name what you're dealing with - triggers, emotions, options - get clear on the situation</p>",
          scenario: '',
        },
        {
          letter: 'T',
          meaning: 'Take',
          definition:
            '<p>Now make your move - but make it consciously, not impulsively</p>',
          scenario: '',
        },
      ],
      explanation:
        "<p>Your emergency brake for impulsive moments - giving yourself space to make choices you'll actually feel good about later.</p>",
    },
    scenarios: [
      {
