const data = [
...

	{
		...
		content: {
			...
			explanation:
				'<p>Your brain runs on snacks, sleep, and not being pissed off. 90 % of dumb decisions start with one of these four gremlins. Fix the basic stuff first—then see if the craving is still there. You can often find H.A.L.T. hanging with the jerks of B.A.D.S so check that tool as well. </p>',
		},
		scenarios: [
			{
