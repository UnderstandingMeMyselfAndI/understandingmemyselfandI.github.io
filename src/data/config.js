	...
	activity: [
		{
			...
			content: [
...

				{
					...
					icon: HandymanIcon,
					content: [
						'<span class="emoji">🔎</span><span>Find tools that work for you.</span>',
						'<span class="emoji">🛠️</span><span>Create your own personal toolbox.</span>',
						'<span class="emoji">📺</span><span>Text & video descriptions.</span>',
						'<span class="emoji">📅</span><span>Private Days Counter X2.</span>',
						...
						'<span class="emoji">ᯤ</span><span>Available online or offline.</span>',
						'<span class="emoji">🏃🏻‍➡️</span><span>Quick exit to Google whenever that could be helpful.</span>',
						'<span class="emoji">🩹</span><span>Erase All Data<br /> at anytime.</span>',
					],
				},
				{
