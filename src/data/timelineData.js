export const TIMELINE_DATA = [
  {
    ...
    events: [
      { id: 101, title: 'Reduction', description: 'Slow reducition of alcohol intake.' },
      ...
      { id: 104, title: 'Medication', description: 'What, if any, medications are being used? <br /> How will these make you feel?' },
      { id: 105, title: 'Location', description: 'Where is the detox taking place? <br />Can you get there on your own?' },
      { id: 106, title: 'Food', description: 'What food is provided during detox? <br />Prep own food if necessary.' },
      { id: 107, title: 'Friends and Family', description: 'What rules are in place for friends and family to visit?' },
      { id: 108, title: 'Rules', description: 'What rules are in place for you? <br />Can you come and go as you please?' },
      { id: 109, title: 'Breathaliser', description: 'When will you be breathalised? <br />What happens if you don\'t blow zero?' },
      { id: 110, title: 'Plan', description: 'You will have time on your hands. <br />What can you do with it positively and keep yourself occupied? <br />Is there a TV, books or anything else? <br />Will you need cash or cards for anything? <br />What is NOT allowed?' },
    ]
  },
  {
    id: 's2',
    ...
    events: [
      ...
      { id: 207, title: 'Be kind to yourself', description: 'Big changes are happening so be kind and patient to yourself. ' },
    ]
  },
  {
    id: 's3',
    ...
    events: [
      ...
      { id: 303, title: 'Blood pressure may be higher', description: 'Blood pressure may be higher.' },
      { id: 304, title: 'Heart rate may increase', description: 'Heart rate may increase.' },
      { id: 305, title: 'Cognitive function impaired', description: 'Cognitive function impaired. Brain fog and confusion can be possible.' },
      { id: 306, title: 'Emotional volatility', description: 'Feeling unusually emotional can happen but entirely normal.' },
      { id: 307, title: 'Cravings intense & persistent', description: 'Cravings intense & persistent.' },
    ]
  },
  {
    id: 's4',
