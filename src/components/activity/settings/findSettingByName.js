export const findSettingByName = (name) => {
  const settingsDataWithStateObjects = [
    {
  ...
  return settingsDataWithStateObjects.find(setting => setting.name === name);
};

// Example usage:
// const yourToolboxSetting = findSettingByName('YourToolbox');
// console.log(yourToolboxSetting);

export default findSettingByName;