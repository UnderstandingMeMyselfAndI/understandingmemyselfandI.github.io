...
db.run("CREATE TABLE IF NOT EXISTS users (token TEXT PRIMARY KEY, alarm_time TEXT)");
...
app.post('/set-alarm', (req, res) => {
  ...
  db.run("INSERT OR REPLACE INTO users (token, alarm_time) VALUES (?, ?)", [token, time], (err) => {
