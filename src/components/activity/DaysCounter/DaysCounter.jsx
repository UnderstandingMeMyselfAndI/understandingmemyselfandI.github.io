			...
			<div className={'days-counter-container' + (dates.length === 2 ? ' full' : '')}>
				{dates.length === 0 && (
					<div className='days-counter-empty-state'>
						...
						<button onClick={() => addDate()} className='days-counter-add-first-btn'>
							Add Date
						</button>
					</div>
				)}
							...
							{date.selectedDate ? (
								<div className='days-counter-values'>
									<div className='days-counter-stat'>
										<span className='value'>{currentTimes[index] && currentTimes[index].days !== undefined ? currentTimes[index].days.toLocaleString() : 0}</span>
							...
							<div className='new-date'>
								...
								<div className='days-counter-selected-date'>
									{date.selectedDate && editingDateIndex !== index ? (
										<span className='days-counter-date-display' onClick={() => handleDateClick(index)} style={{ cursor: 'pointer' }}>
