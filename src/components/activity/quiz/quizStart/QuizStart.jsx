...
const QuizStart = ({ onStart, levels }) => {
	...
	return (
		<div className='quiz-start'>
				...
				<div className='radio-group'>
					{levelKeys.map((level) => (
						<label key={level} className='radio-option'>
							<input type='radio' name='difficulty' value={level} checked={selectedLevel === level} onChange={(e) => setSelectedLevel(e.target.value)} />
			...
			<div className='opt-in-info'>*Scores are only saved to your device and will not be shared anywhere else.</div>
