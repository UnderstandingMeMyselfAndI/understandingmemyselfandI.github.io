...
const questions = [
  {
    ...
    options: ['United States', 'United Kingdom', 'Canada', 'Australia', 'Other/Not sure'],
    followUp: 'Awesome, that helps me point you to stuff that might feel more familiar!',
  },
  {
    ...
    followUp: "Got it – sounds like you're taking a great step. Let's start with some tools that might help!",
  },
];

const WelcomePhase = () => {
  const { currentQuestionIndex, nextPhase, loadResponses } = useOnboardingStore();
